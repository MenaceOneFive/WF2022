...
import { ProductReservation } from "./UI/Products/ProductResevation";
    ...
    return (
        <BrowserRouter>
            <Routes>
                ...
                <Route path="/reservation/:productID" element={<ProductReservation/>}/>
            </Routes>
        </BrowserRouter>
    )
}
/*
<Route path="/reservation/:num" element={<ProductReservation/>}/>
